...
export default function Receipts() {
  ...
  async function handleDelete(receipt: Receipt) {
    if (!window.confirm(`Delete this R${receipt.total_amount} receipt from ${receipt.store_name}? This can't be undone.`)) {
      return;
    }
    ...
    try {
      ...
      setToast('Could not delete that receipt — try again.');
    } finally {
      setDeletingId(null);
    }
  }
